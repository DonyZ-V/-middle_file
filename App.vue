...
body {
  margin: 0;
  font-family: Arial, "Segoe UI", "Lucida Grande", Helvetica, "Microsoft YaHei",
    FreeSans, Arimo, "Droid Sans", "wenquanyi micro hei", "Hiragino Sans GB",
    "Hiragino Sans GB W3", sans-serif, "Helvetica Neue", STHeiti;
  font-weight: 400;
  color: #333;
  font-size: 1.6rem;
}
...
@font-face {
  ...
  src: url("//at.alicdn.com/t/font_c5zd9f9othvndn29.eot?#iefix")
